...
do
	...
	current_x2 = (4.0d0 - (2.0d0 * current_x1) - previous_x3 + previous_x4 - previous_x5)/(2.0d0)
	current_x3 = ((-3.0d0 * current_x1) - (current_x2) + (2.0d0 * previous_x4) - (3.0d0 * previous_x5) + 8.0d0)/(-3.0d0)
	current_x4 = ((current_x1 * -4.0d0) - current_x2 + current_x3 + (5.0d0 * previous_x5) + 16.0d0)/(4.0d0)
	current_x5 = ((-16.0d0 * current_x1) + current_x2 - current_x3 + current_x4 + 32.0d0)/(-1.0d0)
